...
async def register_attendance(request: Request, attendance: AttendanceRecord, authorization: str = Header(None)):
...
@router.post("/excuse")
async def create_excuse(request: Request, excuse: Excuse, authorization: str = Header(None)):
...
async def approve_excuse(request: Request, approval: ExcuseApproval, authorization: str = Header(None)):
...
async def get_pending_excuses(request: Request, authorization: str = Header(None)):
...
async def delete_attendance(request: Request, asistencia_id: int, authorization: str = Header(None)):
...
async def get_my_excuses(request: Request, authorization: str = Header(None)):
