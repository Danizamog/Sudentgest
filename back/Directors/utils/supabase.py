...
def get_institution_name_from_domain(domain: str) -> str:
    """Obtener el nombre de la institución desde el dominio"""
    domain_mapping = {
        "ucb.edu.bo": "Universidad Católica Boliviana",
        "upb.edu.bo": "Universidad Privada Boliviana", 
        "gmail.com": "Institución Demo"
    }
    return domain_mapping.get(domain, "Institución Desconocida")